    ...
    private class AddPlaceButtonListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (latitudeContent != null && longitudeContent != null && nameContent != null
                    && !latitudeContent.isEmpty() && !longitudeContent.isEmpty() && !nameContent.isEmpty()) {
                navigateToLocation(Double.parseDouble(latitudeContent),
    ...
    private class ClearPlacesButtonListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (places == null || places.isEmpty()) {
                Toast.makeText(GoogleMapsActivity.this, "Nothing to clear!!!!", Toast.LENGTH_SHORT).show();
                return;
            }
